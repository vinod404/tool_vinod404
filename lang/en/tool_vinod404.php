...
$string['event_entry_created'] = 'The user with id {$a->userid} created an entry with id {$a->entryid} in course with id {$a->courseid}.';
$string['event_entry_deleted'] = 'The user with id {$a->userid} deleted an entry with id {$a->entryid} in course with id {$a->courseid}.';
